...
class SetRow(SetRowTemplate):
  ...
  def _build_ui(self):
    ...
    self.row.add_component(self.menu_anchor, row="A", col_xs=0, width_xs=1)

    self.controls = FlowPanel()
    ...
    self.row.add_component(self.controls, row="A", col_xs=1, width_xs=10)

    self.check_btn = Button(text="", role="check-button")
    self.check_btn.width = 24
    self.row.add_component(self.check_btn, row="A", col_xs=11, width_xs=1)

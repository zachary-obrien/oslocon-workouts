...
class UnfinishedWorkoutModal(UnfinishedWorkoutModalTemplate):
    ...
    def _build_ui(self):
        ...
        head.add_component(Label(text="Some sets are unfinished", role="exercise-title", spacing_above="none", spacing_below="none"))
        ...
        self.root.add_component(Label(text=title, role="exercise-title", spacing_above="none", spacing_below="none"))
        ...
        if not self.sets_autocompleted:
            finish = Button(text="Finish Remaining Sets", role="button-secondary")

...
class ExerciseCard(ExerciseCardTemplate):
  ...
  def _build_ui(self):
    ...
    self.summary_panel.add_component(self.status_label)
    self.root.add_component(self.summary_panel, full_width_row=True)
  ...
  def _apply_roles(self, collapsed=False):
